...
def main() -> int:
    ...
    print()
    rule()
    print("4. WHAT COULD NOT BE SOURCED, AND THE FOURTH DEPENDENCY INVERSION")
    rule()
    for line in [
        "  RENAL POTASSIUM CLEARANCE IN HEALTHY ADULTS. Searches for fractional potassium",
        "  excretion, potassium clearance and renal potassium handling return diabetic",
        "  ketoacidosis, chronic kidney disease, diuretic therapy, transplantation,",
        "  Gitelman syndrome and pseudohypoaldosteronism. Directive 1.7 disqualifying a",
        "  SIXTH literature, which the pre-registration predicted in advance.",
        "",
        ...
        "  The pattern is now the rule rather than the exception:",
        "",
        "      WHERE A CONCENTRATION IS MEASURED IN THOUSANDS OF PEOPLE AND ITS CLEARANCE",
        "      IS MEASURED IN NOBODY HEALTHY, THE CONCENTRATION IS THE INPUT.",
        "",
