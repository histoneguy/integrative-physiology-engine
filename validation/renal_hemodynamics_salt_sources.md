...
1.5 forbids resolving that by picking the dimensionally sensible reading. **Needs the full
text.**
...
- **Renal haemodynamics across salt intake in healthy WOMEN.** Only Toering 2018, and only
  as a direction. Krikken, van den Bosch, Visser, Barba, Textor, Kirkendall and Rorije are
  **all male**.
